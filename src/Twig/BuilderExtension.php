...
class BuilderExtension extends AbstractExtension
{
    ...
    public function getFunctions()
    {
        return array(
            ...
            new Twig_SimpleFunction('getAvailableBuilderFields', array($this, 'getAvailableBuilderFields')),
        );
    }
    ...
    public function getAvailableBuilderFields() 
    {
        return $this->availableBuilderFields;
    }
