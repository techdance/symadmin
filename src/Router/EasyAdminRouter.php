...
use App\Manager\EasyAdminConfigManager;
...
final class EasyAdminRouter
{
    ...
    public function __construct(EasyAdminConfigManager $configManager, UrlGeneratorInterface $urlGenerator, PropertyAccessorInterface $propertyAccessor, RequestStack $requestStack = null)
    {
